...
void printNodes(float dataToCompare);
...
cout << "0" << ltm->tm_min << ":";
  ...
  // optionally, increase the delay between retries & # of retries
	...
	while (1)
	{
		...
		uploadData();
		sleep(2);
		printNodes(SensorNode1.sensor1);
...
if (millis()-last_printout > NODE_PRINTOUT_DELAY && dataToCompare != dataToCompareOld)
{
	dataToCompareOld = dataToCompare;
	clear();
...
void uploadData(void) {
	...
	char* url1 = "http://www.rxtx-designs.com/saa/upload_values.php?tempin=";
	char* url2 = convertFloat(Sensornode2.sensor1);
	char* url3 = "&temp=";
	char* url4 = convertFloat(Sensornode1.sensor1);
	char* total_url = url1 + url2 + url3 + url4;
